...
export default function RegisterPage(){
    ...
    let imgs = [
        'https://img.freepik.com/premium-vector/alternative-renewable-energy-solar-energy-technological-solar-panels-save-energy-planet_566886-668.jpg'    ];
              ...
              <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form>
                  ...
                  <div className="form-outline mb-3">
                    <input type="name" value={username} onChange={(e) => setUserName(e.target.value)} id="form3Example3" className="form-control form-control-lg" placeholder="Enter your name" />
                  ...
                  <div className="text-center text-lg-start mt-4 pt-2">
                    ...
                    <p className="small fw-bold mt-2 pt-1 mb-0">Already have an account? <a href="/login" className="link-success">Login here</a></p>
                  </div>
